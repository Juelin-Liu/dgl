...
def get_parser():
    ...
    parser.add_argument('--num_epoch', default=3, type=int, help='Number of epochs (default 20)')
    ...
    parser.add_argument('--system', default="dgl", type=str, help='System setting', choices=["dgl", "p3", "quiver", "split", "groot-uva", "groot-cache"])
...
if __name__ == "__main__":
    ...
    elif "split" in system:
        bench_split(config, "dst", "freq", "xbal")
