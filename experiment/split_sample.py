from simulation.split_simu import *
import argparse
import os
from node.utils import Config
...
def get_parser():
    ...
    parser.add_argument('--node_mode', default="dst", type=str, help="Node weight configuraion", choices=["uniform", "degree", "src", "dst", "input", "random"] )
    parser.add_argument('--edge_mode', default="freq", type=str, help="Edge weight configuraion", choices=["uniform", "freq", "random"])
